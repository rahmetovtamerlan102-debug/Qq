...
def clean_value(value):
    ...
    if isinstance(value, dict):
        # Если словарь с url, показываем только url
        if 'url' in value:
            return value.get('url')
        # Если словарь с name, показываем name
        if 'name' in value:
            return value.get('name')
        # Если словарь с username, показываем username
        if 'username' in value:
            return value.get('username')
        # Если словарь с id, показываем id
        if 'id' in value:
            return value.get('id')
        # Если словарь с value, показываем value
        if 'value' in value:
