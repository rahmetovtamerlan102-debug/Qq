...
async def collect_phone_data(query: str):
    ...
    if bigbase:
        ...
        for person in persons:
            ...
            # Дата рождения - из head.head_birthday
            ...
            # Дата рождения - из других возможных ключей
    ...
    # ---- ВЫБИРАЕМ ЛУЧШУЮ ДАТУ И РАССЧИТЫВАЕМ ВОЗРАСТ ----
    if all_birthdates:
...
async def main():
    await init_db()
    print("🚀 Бот запущен (финальная версия с полным парсингом BigBase)")
