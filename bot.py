...
# ============================================================
# ВСПОМОГАТЕЛЬНАЯ ФУНКЦИЯ СКЛОНЕНИЯ ДНЕЙ
# ============================================================
...
# ============================================================
# ГЕНЕРАТОР HTML ОТЧЁТА (ПОЛНЫЙ, С ДИЗАЙНОМ)
# ============================================================
...
# ============================================================
# ФУНКЦИИ РАБОТЫ С ПОЛЬЗОВАТЕЛЯМИ И РЕФЕРАЛЬНОЙ СИСТЕМОЙ
# ============================================================
...
# ============================================================
# БОТ (объявлен ДО использования декораторов)
# ============================================================
bot = Bot(token=BOT_TOKEN)
dp = Dispatcher(storage=MemoryStorage())

# ============================================================
# КОМАНДА /start (с реферальной обработкой)
# ============================================================
...
async def start_cmd(message: types.Message):
            ...
            try:
                ...
                if ref_user:
                    ...
                    await bot.send_message(
                        referrer_id,
                        f"По вашей реферальной ссылке перешёл пользователь {ref_username} (ID: {user_id}). Вы получили +1 бонусный запрос."
                    )
            except Exception:
                pass
    else:
    ...
    # Главное меню: Мой профиль и Реферальная система
...
# ============================================================
# КОЛБЭК "Мой профиль" (БЕЗ РЕФЕРАЛЬНОЙ ИНФОРМАЦИИ)
# ============================================================
...
# ============================================================
# КОЛБЭК "Реферальная система" (ОТДЕЛЬНАЯ КНОПКА)
# ============================================================
...
# ============================================================
# КОЛБЭК "Ввести промокод" и его FSM обработка
# ============================================================
...
# ============================================================
# КОЛБЭК "Назад" (главное меню с двумя кнопками)
# ============================================================
...
# ============================================================
# ОБРАБОТЧИКИ FSM ДЛЯ АДМИН-ФУНКЦИЙ
# ============================================================
