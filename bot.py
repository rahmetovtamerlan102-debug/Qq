...
# Безлимитный режим (для тестирования) – установите UNLIMITED=true в .env
UNLIMITED = os.getenv("UNLIMITED", "false").lower() == "true"
...
async def main():
    await init_db()
    print("🚀 Бот запущен (оптимизированный, без лишних кнопок)")
