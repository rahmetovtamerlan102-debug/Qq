...
# ============================================================
# ГЕНЕРАТОР HTML ОТЧЁТА (полный, со стилями и скриптами)
# ============================================================
...
# ============================================================
# ФУНКЦИИ РАБОТЫ С ПОЛЬЗОВАТЕЛЯМИ И ПРОМОКОДАМИ
# ============================================================
...
async def get_daily_requests(user_id: int) -> int:
    ...
    async with pool.acquire() as conn:
        row = await conn.fetchrow('''
            SELECT daily_requests, bonus_requests, last_request_date FROM users WHERE user_id = $1
        ''', user_id)
        if not row:
            return 0
        if row['last_request_date'] != datetime.now().date():
            return 0
        return row['daily_requests']
...
# ============================================================
# ОБРАБОТЧИКИ FSM ДЛЯ СОЗДАНИЯ ПРОМОКОДА
# ============================================================
...
# ============================================================
# ОБРАБОТЧИКИ FSM ДЛЯ ВЫДАЧИ ЗАПРОСОВ (два шага)
# ============================================================
